...
const MovieCard = ({
  ...
  return (
    <>
      <div className="card bg-dark mx-auto" style={{ width: "18rem" }}>
        <img src={image} className="card-img-top" alt="..." />
        <div className="card-body">
          <h5 className="card-title ml-10 fw-bold">{name}</h5>
        </div>
        <hr></hr>
        ...
        <div className="card-body card-body-btn">
          <button
            className="w-100 btn btn-secondary border border-white custSearchBtn p-1 m-2 pt-0 "
